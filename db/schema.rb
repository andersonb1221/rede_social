...
ActiveRecord::Schema[7.1].define(version: 2024_10_24_012503) do
  ...
  create_table "seguidors", force: :cascade do |t|
    ...
    t.string "avatar"
    t.string "bio"
    t.index ["seguidor_id", "seguido_id"], name: "index_seguidors_on_seguidor_id_and_seguido_id", unique: true
    t.index ["user_id"], name: "index_seguidors_on_user_id"
  end
  ...
  create_table "seguidos", force: :cascade do |t|
    ...
    t.string "avatar"
    t.string "bio"
    t.index ["user_id"], name: "index_seguidos_on_user_id"
  end
  ...
  add_foreign_key "seguidors", "users"
  add_foreign_key "seguidos", "users"
end
